...
var author$project$Main$isLaunchWeek = F3(
...
var author$project$Main$viewHeatCell = function (weekend) {
	switch (weekend.$) {
		case 'Scheduled':
			var launch = weekend.a;
			return A2(
				elm$html$Html$td,
				_List_fromArray(
					[
...
var author$project$Main$viewHeatMap = F2(
	function (model, d) {
		var utc = elm$time$Time$utc;
		var start = A2(
			justinmimbs$time_extra$Time$Extra$partsToPosix,
			utc,
			A7(justinmimbs$time_extra$Time$Extra$Parts, 2013, elm$time$Time$Jan, 1, 0, 0, 0, 0));
		var until = A4(justinmimbs$time_extra$Time$Extra$add, justinmimbs$time_extra$Time$Extra$Year, 7, utc, start);
				...
				[
					...
					A2(
						...
						function (sundayPosix) {
							var weekend = A3(author$project$Main$isLaunchWeek, sundayPosix, d.launches, model.time);
							return author$project$Main$viewHeatCell(weekend);
						},
						sundays))
				]));
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$href('https://sorabatake.jp'),
							elm$html$Html$Attributes$target('_blank')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('sorabatake')
						]))
				]))
		]));
					...
					[
						...
						_List_fromArray(
							[
								...
								A2(
									elm$core$List$map,
									author$project$Main$viewHeatMap(model),
									model.resultChunk))
							]))
					])),
